...
@section('title', 'Trend Moment Terms')
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <a href="#" id="mt" class="terms col-xl-4 col-md-12">
                                    <div class="mt card bg-blue-600 dashnum-card text-white overflow-hidden">
                                        <span class="round small"></span>
                                        <span class="round big"></span>
                                        <div class="card-body">
                                            <div class="row">
                                ...
                                <a href="#" id="lt" class="terms col-xl-4 col-md-12">
                                    <div class="lt card bg-yellow-600 dashnum-card text-white overflow-hidden">
                                        <span class="round small"></span>
                                        <span class="round big"></span>
                                        <div class="card-body">
                                            <div class="row">
